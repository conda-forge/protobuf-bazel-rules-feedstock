...
pixi add protobuf-bazel-rules
# for installing globally
pixi global install protobuf-bazel-rules
```
...
It is possible to list all of the versions of `protobuf-bazel-rules` available on your platform:
...
```
pixi search protobuf-bazel-rules --channel conda-forge
```
